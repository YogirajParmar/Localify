      ...
      <main>
        ...
        <section class="jobs">
          ...
          <ul class="job-list">
            ...
            <?php
              ...
              $query = "SELECT * FROM job WHERE ServiceMan_Name = '".$servicemanuser."' AND Status = 'pending'";
              $result = mysqli_query($conn, $query);
              ...
              while($row = mysqli_fetch_assoc($result)){
                  ...
                  <div class="job">
                      ...
                      <div class="complete-btn">
                          <form method="post">
                              <button name="complete" value="'.$row["job_ID"].'">Job Done</button>
                          </form>
                      </div>
                  </div>
                  ';
        ...
        <section class="map">
          ...
          <?php
              ...
              $query = "SELECT * FROM job WHERE ServiceMan_Name = '".$servicemanuser."' AND Status = 'complete'";
              $result = mysqli_query($conn, $query);
